! function(a) {
    ...
    function f(f, h) {
        ...
        function n() {
            ...
            if (p && xa.find("*:not(input)").attr("unselectable", "on"), j(), Pa && va.after(Qa).hide(), Ya || Ka.hide(), V) va.after(xa).hide();
            else {
        ...
        function L() {
            ...
            var c = I({
                ...
                d = "";
            if (Sa.removeClass("sp-clear-display"), Sa.css("background-color", "transparent"), !c && Ya) Sa.addClass("sp-clear-display");
            else {
                var e = c.toHexString(),
                    f = c.toRgbString();
        ...
        function M() {
            var a = ka,
                b = la;
            if (Ya && Xa) Fa.hide(), Ca.hide(), Aa.hide();
            else {
        ...
        var U = e(h, f),
            ...
            Wa = !U.showButtons || U.clickoutFiresChange,
            Xa = !Ta,
            Ya = U.allowEmpty && !Oa;
        n();
        var Za = {
